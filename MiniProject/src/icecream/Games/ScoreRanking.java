...
public class ScoreRanking {
	...
	public void readTxt() {	// 텍스트파일 읽어와서 리스트에 저장
		try(BufferedReader br = new BufferedReader(new FileReader("src/icecream/Games/resources/Ranking.txt"));) {
			rankList.clear();
			while(true) {
	...
	public void saveTxt() {	// 파일로 내보내기 
		file = new File("src/icecream/Games/resources/Ranking.txt");
