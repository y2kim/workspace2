...
import fly.dodge.Dodge;
import fly.dodge.DodgeRanking;
...
public class Game5 extends JPanel {
	...
	private JLabel gameName = new JLabel("dodge ");
	...
	private Font myFont;
	 ...
	 private ImageIcon gameImg = new ImageIcon("src/Games/res/dot.png"); 
	...
	private void compInit() {
		 try {
			...
			this.gamepanel.setPreferredSize(new Dimension(303, 304));
