...
import trex.ScoreRanking;

public class NewGameOverDialog extends JDialog{
	NewGameOverDialog ngod = this;
	GameWindow gw;
	...
	private void compInit() {
		...
		JLabel gameover = new JLabel(new ImageIcon("src/trex/resources/gameover.png"));
	...
	public NewGameOverDialog(int score, GameWindow parent) {
		...
		int size = sr.setSize(ScoreRanking.rankList);
		if(size <= 4) {
