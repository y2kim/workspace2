...
public class Land {
	...
	public Land(int width, MainCharacter mainCharacter) {
		...
		land1 = Resource.getResouceImage("/trex/data/land1.png");
		land2 = Resource.getResouceImage("/trex/data/land2.png");
		land3 = Resource.getResouceImage("/trex/data/land3.png");
	...
	public void update(){// 땅이 가버리면 다시 생성 
		...
		if(firstElement.posX < -land1.getWidth()) { // 범위 밖으로 벗어날때
			listLand.remove(firstElement); // 삭제 
	...
	private void setImageLand(ImageLand imgLand) {//선택후 땅 이미지 연결
