...
class GameOverDialog extends JDialog {
   ...
   public static boolean avoidrank ;
   ...
   private void compInit() {
      ...
      JLabel gameover = new JLabel(new ImageIcon(this.getClass().getResource("").getPath()+"/gameover.png"));
   ...
   public GameOverDialog(int score, AvoidBomb caller) {
